...
def load_gt(infos_path, verbose: bool = True) -> EvalBoxes:
    """
    ...
    for sample in tqdm.tqdm(samples, leave=verbose):
        ...
        sample_boxes = output_to_nusc_box(sample)
...
if __name__ == '__main__':
    ...
    load_gt('./aimotive3dLidarCamera_mini_infos_val.pkl')
