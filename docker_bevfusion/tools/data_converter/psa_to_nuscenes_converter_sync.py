...
if __name__ == '__main__':
    ...
    seq_paths = ['20220125_153725_Rec_JLAB09'] # If more than 1 sequence, data will be merged to the final pkl files 
   
    create_psa_infos(root_data_path,[],seq_paths,'psa3dLidarOneCamera_sync_20220125_153725_Rec_JLAB09')
